...
names <- c(
  "Other", "Rhogobius", "Nilva torifera", "Stygiopontius hispidulus", "Aphotopontius mammillatus", "Ceuthoecetes acanthothrix"
)

# Name is an ordered factor. We do this to ensure the bars are sorted.
data <- data.frame(
  count = c(9.33, 5.60, 6.15, 10.98, 31.94, 36.00), 
  name = factor(names, levels = names),
  y = seq(length(names)) * 0.9,
  percentages = c("9.33%", "5.60%", "6.15%", "10.98%", "31.94%", "36%")
)
